  ...
  render() {
    ...
    return (
      <form onSubmit={this._submitHandler.bind(this)}>
        <h3>회원 가입</h3>
        <input type="text" ref="reg_id" placeholder="아이디 (영문,숫자 조합)" required/>
        <input type="text" ref="reg_nickname" placeholder="닉네임" required/>
...
RegisterForm.propTypes = {
  ...
  reg_error: PropTypes.string.isRequired
};